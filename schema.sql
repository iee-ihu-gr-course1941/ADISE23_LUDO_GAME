...
CREATE TABLE IF NOT EXISTS `board` (
  ...
  `b_color` enum('R','G','B','Y','W','MIX') NOT NULL,
...
INSERT INTO `board` (`x`, `y`, `b_color`, `piece_color`, `piece`, `y_path`, `b_path`, `r_path`, `g_path`) VALUES
	...
	(5, 5, 'MIX', NULL, NULL, NULL, NULL, NULL, NULL),
	(5, 6, 'G', NULL, NULL, NULL, NULL, NULL, 39),
	(5, 7, 'MIX', NULL, NULL, NULL, NULL, NULL, NULL),
	...
	(7, 5, 'MIX', NULL, NULL, NULL, NULL, NULL, NULL),
	(7, 6, 'B', NULL, NULL, NULL, 39, NULL, NULL),
	(7, 7, 'MIX', NULL, NULL, NULL, NULL, NULL, NULL),
...
-- Dumping data for table adise23_ludo_game.players: ~0 rows (approximately)
