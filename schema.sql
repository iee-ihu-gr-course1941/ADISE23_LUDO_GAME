...
-- Dumping data for table adise23_ludo_game.blue_win_pieces: ~1 rows (approximately)
DELETE FROM `blue_win_pieces`;
INSERT INTO `blue_win_pieces` (`piece`, `piece_color`, `id`) VALUES
	('B1', 'B', 1),
	('B2', 'B', 2),
	('B3', 'B', 3),
	('B4', 'B', 4);
...
INSERT INTO `board` (`x`, `y`, `b_color`, `piece_color`, `piece`, `y_path`, `b_path`, `r_path`, `g_path`) VALUES
	...
	(2, 10, 'W', NULL, NULL, NULL, NULL, NULL, NULL),
	...
	(20, 1, '', 'B', 'B1', NULL, 41, NULL, NULL),
	(20, 2, '', 'B', 'B2', NULL, 42, NULL, NULL),
	(20, 3, '', 'B', 'B3', NULL, 43, NULL, NULL),
	(20, 4, '', 'B', 'B4', NULL, 44, NULL, NULL),
	...
	(40, 1, '', 'G', 'G1', NULL, NULL, NULL, 41),
	(40, 2, '', 'G', 'G2', NULL, NULL, NULL, 42),
...
INSERT INTO `dice` (`prev_x`, `prev_y`, `new_x`, `new_y`, `created_at`, `p_turn`, `piece`, `dice`, `prev_path`, `new_path`) VALUES
	(20, 1, 20, 1, '2024-01-10 09:58:49', 'B', 'B1', 1, 41, 41),
	(20, 2, 20, 2, '2024-01-10 09:58:49', 'B', 'B2', 1, 42, 42),
	(20, 3, 20, 3, '2024-01-10 09:58:49', 'B', 'B3', 1, 43, 43),
	(10, 2, 10, 5, '2024-01-10 09:58:49', 'B', 'B4', 1, NULL, 1),
	(40, 1, 40, 1, '2024-01-10 09:58:49', 'G', 'G1', 1, 41, 41),
	(40, 2, 40, 2, '2024-01-10 09:58:49', 'G', 'G2', 1, 42, 42),
	(2, 9, 2, 7, '2024-01-10 09:58:49', 'G', 'G3', 1, NULL, 1),
	(3, 9, 2, 7, '2024-01-10 09:58:49', 'G', 'G4', 1, NULL, 1),
	(9, 10, 7, 10, '2024-01-10 09:58:49', 'R', 'R1', 1, NULL, 1),
	(10, 10, 7, 10, '2024-01-10 09:58:49', 'R', 'R2', 1, NULL, 1),
	(9, 9, 7, 10, '2024-01-10 09:58:49', 'R', 'R3', 1, NULL, 1),
	(10, 9, 7, 10, '2024-01-10 09:58:49', 'R', 'R4', 1, NULL, 1),
	(2, 3, 5, 2, '2024-01-10 09:58:49', 'Y', 'Y1', 1, NULL, 1),
	(3, 3, 5, 2, '2024-01-10 09:58:49', 'Y', 'Y2', 1, NULL, 1),
	(2, 2, 5, 2, '2024-01-10 09:58:49', 'Y', 'Y3', 1, NULL, 1),
	(3, 2, 5, 2, '2024-01-10 09:58:49', 'Y', 'Y4', 1, NULL, 1);
...
-- Dumping data for table adise23_ludo_game.green_win_pieces: ~1 rows (approximately)
DELETE FROM `green_win_pieces`;
INSERT INTO `green_win_pieces` (`piece`, `piece_color`, `id`) VALUES
	('G1', 'G', 1),
	('G2', 'G', 2);
...
CREATE TABLE IF NOT EXISTS `missing_pieces` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2506 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `players` (`username`, `piece_color`, `token`, `last_action`) VALUES
	('b', 'B', 'ec67cec123431936393b277700a7c01d', '2024-01-10 09:59:19'),
	(NULL, 'R', NULL, NULL),
	('g', 'G', 'a3f2522bfd7b96e23ebf266c918bd99b', '2024-01-10 09:59:25'),
	(NULL, 'Y', NULL, NULL);
